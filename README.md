...
The live site is deployed with [Railway](https://railway.com/) with a hosted postgres db using [Neon](https://neon.com/), and authentication is handled by [Auth0](https://auth0.com/).
